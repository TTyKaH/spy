<template>
  <div
    ...
    <div class="wrap wrap-py flex gap-3 flex-col justify-center">
      <h1>Что-то пошло не так!</h1>
      <svg
        id="Layer_1" filter="grayscale(1)" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
        ...
        <ellipse
          class="cls-2" cx="748.2" cy="816.89" rx="202.22" ry="30.98"
